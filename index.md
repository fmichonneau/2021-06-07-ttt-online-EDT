...
humandate: "Jun 7-10, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Angela Li", "François Michonneau"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
etherpad: https://pad.carpentries.org/2021-06-07-ttt-online-edt             # optional: URL for the workshop Etherpad if there is one
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event will be communicated to you before the event starts.
